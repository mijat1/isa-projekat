...
class CourseFutureReservationsPage extends Component {
  ...
  componentDidMount() {
    ...
    Axios.get(API_URL + "/reservation/findAllFutureCourseReservationClient", {
			validateStatus: () => true,
  ...
  hasRole = (requestRole) => {
    ...
    moveToReservationHistory =() => {
       ...
       this.props.history.push("/historyCourseReservation");
    }
...
export default CourseFutureReservationsPage;