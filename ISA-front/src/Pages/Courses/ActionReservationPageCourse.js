...
class ActionReservationPageCourse extends Component {
  ...
  componentDidMount() {
    ...
    Axios.get(API_URL + "/reservation/findAllActionCourseReservationClient", {
			validateStatus: () => true,
...
export default ActionReservationPageCourse;