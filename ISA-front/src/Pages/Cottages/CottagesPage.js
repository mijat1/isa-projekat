...
class CottagesPage extends Component {
	...
	componentDidMount() {
		...
		Axios.get(API_URL + "/cottage/allCottages")
	...
	handleSearchClick = () => {
		{
			...
			Axios.get(API_URL+ "/cottage/allCottagesWithFreePeriod", {
				params: {
	...
	handleSortByPriceAscending = () => {
		...
		if (gradeFrom === "") gradeFrom = -1;
			if (gradeTo === "") gradeTo = -1;
             ...
             console.log("sok");
			Axios.get( API_URL + "/cottage/getAllFreeCottagesForSelectedDate/SortByPriceAscending"  , {
				params: {
					DateTime:startDateSelected,
					days: days,
					people: people,
	...
	handleSortByPriceDescending = () => {
		...
		let startDateSelected= new Date(
			...
			0
             ...
             console.log("sok");
			Axios.get( API_URL + "/cottage/getAllFreeCottagesForSelectedDate/SortByPriceDescending" , {
				params: {
					DateTime:startDateSelected,
					days: days,
					people: people,
	...
	handleSortByGradeAscending = () => {
		...
		if (gradeFrom === "") gradeFrom = -1;
			if (gradeTo === "") gradeTo = -1;
             ...
             console.log("sok");
			Axios.get( API_URL + "/cottage/getAllFreeCottagesForSelectedDate/SortByGradeAscending" , {
				params: {
					DateTime:startDateSelected,
					days: days,
					people: people,
	...
	handleSortByGradeDescending = () => {
		...
		if (gradeFrom === "") gradeFrom = -1;
			if (gradeTo === "") gradeTo = -1;
             ...
             console.log("sok");
			Axios.get( API_URL + "/cottage/getAllFreeCottagesForSelectedDate/SortByGradeDescending"   , {
				params: {
					DateTime:startDateSelected,
					days: days,
					people: people,
