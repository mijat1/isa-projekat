...
class CottageFutureReservationsPage extends Component {
  ...
  componentDidMount() {
    ...
    Axios.get(API_URL + "/reservation/findAllFutureCottageReservationClient", {
			validateStatus: () => true,
  ...
  hasRole = (requestRole) => {
    ...
    moveToReservationHistory =() => {
       ...
       this.props.history.push("/historyCottageReservation");
    }
	...
	render() {
      ...
      <Header/>
         ...
         <h1 hidden={this.state.reservations.length === 0} className="text-center  mt-3  " >Vaše buduće rezervacije!</h1>
...
export default CottageFutureReservationsPage;