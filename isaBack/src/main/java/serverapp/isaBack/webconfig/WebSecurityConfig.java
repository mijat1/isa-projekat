package serverapp.isaBack.webconfig;
...
import serverapp.isaBack.security.auth.RestAuthenticationEntryPoint;
import serverapp.isaBack.security.auth.TokenAuthenticationFilter;
import serverapp.isaBack.service.users.CustomUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring().antMatchers(HttpMethod.POST, "/reg/signupclient");
		web.ignoring().antMatchers(HttpMethod.POST, "/auth/login");
		
		web.ignoring().antMatchers(HttpMethod.POST, "/users/changeFirstPassword");
		
		web.ignoring().antMatchers(HttpMethod.GET, "/boat/allBoats");
		web.ignoring().antMatchers(HttpMethod.GET, "/cottage/allCottages");
		web.ignoring().antMatchers(HttpMethod.GET, "/course/allCourses");
		
		
		web.ignoring().antMatchers(HttpMethod.GET, "/reg/activeAccountClient/**");
